...
const NavBar = ({ ischangeColor = true }) => {
    ...
    return (
        <>
            ...
            >
                <div className="flex w-full items-center justify-around navbar">
                    ...
                    <div className="hidden md:flex items-center space-x-1 navbar-items">
                        <a
                            href="#"
                        ...
                        <a href="#" className="py-2 px-2 font-medium text-white bg-green-500 rounded hover:bg-green-400 transition duration-300 button-content">
                            <div className="hidden md:flex items-center space-x-3 navbar-button">
                                <p>ASSINE AGORA</p>
                            </div>
                        </a>
                    </div>
