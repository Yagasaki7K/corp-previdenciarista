...
const WordpressSection = (props) => {
  return (
    <div className="w-auto flex items-start justify-center m-5 bg-prev-default-text_white">
      <div className="max-w-[1080px] grid-flow-row grid-cols-1 gap-[70px]">
        {sections.map(section => {
          return (
            <div className="flex flex-col items-start my-12 mt-[0px]" key={section.key}>
              <h2 className="font-semibold text-size28 my-8">{section.value}</h2>
